...
export const BIOTECNOLOGIA_MESSAGE = "*BIOTECNOLOGÍA Y NANOTECNOLOGÍA*\n\n"+
...
export const ELECTRONICA_MESSAGE =  "*ELECTRÓNICA Y TELECOMUNICACIONES*\n\n"+
...
export const TECNOLOGIAS_MESSAGE = "*TECNOLOGÍAS VIRTUALES*\n\n" +
...
export const ERROR_MESSAGE = "Hubo un error al procesar tu solicitud. Por favor, inténtalo de nuevo.";
